...
import { ThemaCard } from "./ThemaCard.tsx";
    ...
    <main className={`space-y-16 py-8 ${isEmbedded ? "" : "min-h-screen"}`}>
      ...
      >
        <div className="mx-auto flex max-w-7xl flex-wrap justify-center gap-2">
          ...
          >
            <span
              className={`scale-75 transition-transform ${
      ...
      <button
        ...
        className="fixed right-8 bottom-8 z-50 flex size-14 items-center justify-center rounded-full bg-amber-500 text-black shadow-2xl transition-transform hover:scale-110 active:scale-95"
      >
        <ArrowUp size={28} />
      </button>
    </main>
